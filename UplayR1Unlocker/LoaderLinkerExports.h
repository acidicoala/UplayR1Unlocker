...
#pragma comment(linker, "/export:UPLAY_FRIENDS_IsBlackListed=uplay_r1_loader_o.UPLAY_FRIENDS_IsBlackListed")
#pragma comment(linker, "/export:UPLAY_FRIENDS_IsFriend=uplay_r1_loader_o.UPLAY_FRIENDS_IsFriend")
#pragma comment(linker, "/export:UPLAY_FRIENDS_RemoveFriendship=uplay_r1_loader_o.UPLAY_FRIENDS_RemoveFriendship")
#pragma comment(linker, "/export:UPLAY_FRIENDS_RemoveFromBlackList=uplay_r1_loader_o.UPLAY_FRIENDS_RemoveFromBlackList")
#pragma comment(linker, "/export:UPLAY_FRIENDS_RequestFriendship=uplay_r1_loader_o.UPLAY_FRIENDS_RequestFriendship")
#pragma comment(linker, "/export:UPLAY_FRIENDS_RespondToGameInvite=uplay_r1_loader_o.UPLAY_FRIENDS_RespondToGameInvite")
#pragma comment(linker, "/export:UPLAY_FRIENDS_ShowFriendSelectionUI=uplay_r1_loader_o.UPLAY_FRIENDS_ShowFriendSelectionUI")
#pragma comment(linker, "/export:UPLAY_FRIENDS_ShowInviteFriendsToGameUI=uplay_r1_loader_o.UPLAY_FRIENDS_ShowInviteFriendsToGameUI")
#pragma comment(linker, "/export:UPLAY_GetLastError=uplay_r1_loader_o.UPLAY_GetLastError")
#pragma comment(linker, "/export:UPLAY_GetNextEvent=uplay_r1_loader_o.UPLAY_GetNextEvent")
#pragma comment(linker, "/export:UPLAY_GetOverlappedOperationResult=uplay_r1_loader_o.UPLAY_GetOverlappedOperationResult")
#pragma comment(linker, "/export:UPLAY_HasOverlappedOperationCompleted=uplay_r1_loader_o.UPLAY_HasOverlappedOperationCompleted")
#pragma comment(linker, "/export:UPLAY_INSTALLER_AreChunksInstalled=uplay_r1_loader_o.UPLAY_INSTALLER_AreChunksInstalled")
#pragma comment(linker, "/export:UPLAY_INSTALLER_GetChunkIdsFromTag=uplay_r1_loader_o.UPLAY_INSTALLER_GetChunkIdsFromTag")
#pragma comment(linker, "/export:UPLAY_INSTALLER_GetChunks=uplay_r1_loader_o.UPLAY_INSTALLER_GetChunks")
// #pragma comment(linker, "/export:UPLAY_INSTALLER_GetLanguageUtf8=uplay_r1_loader_o.UPLAY_INSTALLER_GetLanguageUtf8")
...
#pragma comment(linker, "/export:UPLAY_OPTIONS_Apply=uplay_r1_loader_o.UPLAY_OPTIONS_Apply")
#pragma comment(linker, "/export:UPLAY_OPTIONS_Close=uplay_r1_loader_o.UPLAY_OPTIONS_Close")
#pragma comment(linker, "/export:UPLAY_OPTIONS_Enumerate=uplay_r1_loader_o.UPLAY_OPTIONS_Enumerate")
#pragma comment(linker, "/export:UPLAY_OPTIONS_Get=uplay_r1_loader_o.UPLAY_OPTIONS_Get")
#pragma comment(linker, "/export:UPLAY_OPTIONS_Open=uplay_r1_loader_o.UPLAY_OPTIONS_Open")
#pragma comment(linker, "/export:UPLAY_OPTIONS_ReleaseKeyValueList=uplay_r1_loader_o.UPLAY_OPTIONS_ReleaseKeyValueList")
#pragma comment(linker, "/export:UPLAY_OPTIONS_Set=uplay_r1_loader_o.UPLAY_OPTIONS_Set")
#pragma comment(linker, "/export:UPLAY_OPTIONS_SetInGameState=uplay_r1_loader_o.UPLAY_OPTIONS_SetInGameState")
...
#pragma comment(linker, "/export:UPLAY_PARTY_GetId=uplay_r1_loader_o.UPLAY_PARTY_GetId")
#pragma comment(linker, "/export:UPLAY_PARTY_GetInGameMemberList=uplay_r1_loader_o.UPLAY_PARTY_GetInGameMemberList")
#pragma comment(linker, "/export:UPLAY_PARTY_Init=uplay_r1_loader_o.UPLAY_PARTY_Init")
#pragma comment(linker, "/export:UPLAY_PARTY_InvitePartyToGame=uplay_r1_loader_o.UPLAY_PARTY_InvitePartyToGame")
#pragma comment(linker, "/export:UPLAY_PARTY_InviteToParty=uplay_r1_loader_o.UPLAY_PARTY_InviteToParty")
#pragma comment(linker, "/export:UPLAY_PARTY_IsInParty=uplay_r1_loader_o.UPLAY_PARTY_IsInParty")
...
#pragma comment(linker, "/export:UPLAY_PRODUCT_GetProductList=uplay_r1_loader_o.UPLAY_PRODUCT_GetProductList")
#pragma comment(linker, "/export:UPLAY_PRODUCT_ReleaseProductList=uplay_r1_loader_o.UPLAY_PRODUCT_ReleaseProductList")
...
#pragma comment(linker, "/export:UPLAY_SAVE_Read=uplay_r1_loader_o.UPLAY_SAVE_Read")
#pragma comment(linker, "/export:UPLAY_SAVE_ReleaseGameList=uplay_r1_loader_o.UPLAY_SAVE_ReleaseGameList")
#pragma comment(linker, "/export:UPLAY_SAVE_Remove=uplay_r1_loader_o.UPLAY_SAVE_Remove")
#pragma comment(linker, "/export:UPLAY_SAVE_SetName=uplay_r1_loader_o.UPLAY_SAVE_SetName")
#pragma comment(linker, "/export:UPLAY_SAVE_Write=uplay_r1_loader_o.UPLAY_SAVE_Write")
#pragma comment(linker, "/export:UPLAY_STORE_Checkout=uplay_r1_loader_o.UPLAY_STORE_Checkout")
#pragma comment(linker, "/export:UPLAY_STORE_GetPartner=uplay_r1_loader_o.UPLAY_STORE_GetPartner")
#pragma comment(linker, "/export:UPLAY_STORE_GetProducts=uplay_r1_loader_o.UPLAY_STORE_GetProducts")
#pragma comment(linker, "/export:UPLAY_STORE_IsEnabled=uplay_r1_loader_o.UPLAY_STORE_IsEnabled")
...
#pragma comment(linker, "/export:UPLAY_USER_ReleaseCdKeyList=uplay_r1_loader_o.UPLAY_USER_ReleaseCdKeyList")
#pragma comment(linker, "/export:UPLAY_USER_ReleaseConsumeItemResult=uplay_r1_loader_o.UPLAY_USER_ReleaseConsumeItemResult")
#pragma comment(linker, "/export:UPLAY_USER_ReleaseProfile=uplay_r1_loader_o.UPLAY_USER_ReleaseProfile")
#pragma comment(linker, "/export:UPLAY_USER_SetGameSession=uplay_r1_loader_o.UPLAY_USER_SetGameSession")
#pragma comment(linker, "/export:UPLAY_Update=uplay_r1_loader_o.UPLAY_Update")
#pragma comment(linker, "/export:UPLAY_WIN_GetActions=uplay_r1_loader_o.UPLAY_WIN_GetActions")
#pragma comment(linker, "/export:UPLAY_WIN_GetRewards=uplay_r1_loader_o.UPLAY_WIN_GetRewards")
#pragma comment(linker, "/export:UPLAY_WIN_GetUnitBalance=uplay_r1_loader_o.UPLAY_WIN_GetUnitBalance")
#pragma comment(linker, "/export:UPLAY_WIN_RefreshActions=uplay_r1_loader_o.UPLAY_WIN_RefreshActions")
#pragma comment(linker, "/export:UPLAY_WIN_ReleaseActionList=uplay_r1_loader_o.UPLAY_WIN_ReleaseActionList")
#pragma comment(linker, "/export:UPLAY_WIN_ReleaseRewardList=uplay_r1_loader_o.UPLAY_WIN_ReleaseRewardList")
#pragma comment(linker, "/export:UPLAY_WIN_SetActionsCompleted=uplay_r1_loader_o.UPLAY_WIN_SetActionsCompleted")
